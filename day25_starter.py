...
PATTERNS = {
    "Jump Table": {
        "offset": 0x0000,
        "length": 16,
        "description": "Potential function jump table. Contains pointers to executable code addresses.",
        "detect": lambda d: all(struct.unpack("<I", d[i:i+4])[0] > 0x08000000 for i in range(4, 16, 4)),
    }
}
